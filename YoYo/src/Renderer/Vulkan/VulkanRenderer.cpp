...
namespace yoyo
{
    ...
    void VulkanRenderer::EndFrame()
    {
        ...
        vkCmdBindPipeline(cmd, VK_PIPELINE_BIND_POINT_COMPUTE, m_blit_pipeline);
        // draw...
    ...
    {
        char* buffer;
        Platform::FileRead("/Users/caltax/dev/Yoyo/Sandbox/assets/shaders/lit_shader.vert", &buffer);

        // TODO : VulkanShaderModule CreateShaderModule();
        VkShaderModule module;
        VkShaderModuleCreateInfo shader_info = {};
        shader_info.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
        shader_info.pCode = reinterpret_cast<uint32_t*>(buffer);

        VK_CHECK(vkCreateShaderModule(m_device, &shader_info, nullptr, &module));
        ...
        builder.vertex_input_info.vertexBindingDescriptions = VertexBindingDescriptions().data();
